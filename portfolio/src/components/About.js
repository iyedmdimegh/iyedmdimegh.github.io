...
//                 {typedText}
//               </span>
//               <span className="absolute  right-[-4px] w-[4px] h-12 bg-orange-500 animate-blink"></span>
//             </span>
//           </h1>
//           <button
//             className="inline-flex items-center px-6 py-3 rounded-full bg-gray-100 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 transition-colors duration-300"
...
//             <img
//               src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-eyRhgoaO1Wil8CT8XmPlininMugkNF.png"
//               alt="Profile"
